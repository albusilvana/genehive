...
Backbone.ChildViewContainer = function (e, t) {
    ...
    t.extend(i.prototype, {add: function (e, t) {
        ...
        var i;
        for (var n in this._indexByCustom)if (this._indexByCustom.hasOwnProperty(n) && this._indexByCustom[n] === t) {
            i = n;
            break
        }
    ...
    return n.Handlers = function (e, t) {
        ...
        return i.extend = e.Model.extend, t.extend(i.prototype, e.Events, {setHandlers: function (e) {
        ...
        return i.extend(t.prototype, e.Events, {getCommands: function (e) {
...
var Marionette = function (e, t, i) {
    ...
    return o.extend = t.Model.extend, o.getOption = function (e, t) {
        ...
        var t = /(^|:)(\w)/gi, n = function (n) {
            var r = "on" + n.replace(t, e), o = this[r];
        ...
        var n = "string" == typeof e, r = "string" == typeof e.selector, o = e.regionType === void 0, s = "function" == typeof e;
        ...
        var t = e.Controller.extend({constructor: function (t) {
            ...
            var r, o = i.isObject(n), s = i.isString(n), h = !!n.selector;
    ...
    }}, o.View = t.View.extend({constructor: function () {
    ...
    }, triggerMethod: o.triggerMethod, getTemplate: function () {
    ...
    }}), o.ItemView = o.View.extend({serializeData: function () {
        var e = {};
    ...
    }}), o.CompositeView = o.CollectionView.extend({_initialEvents: function () {
        ...
        var t = this, i = {parentEl: function () {
            return t.$el
        }};
    ...
    }, i.extend(o.Module.prototype, t.Events, {addInitializer: function (e) {
    ...
    }}), i.extend(o.Module, {create: function (e, t, r) {
        var o = e, s = n(arguments);
