define([
    ...
    return BaseModel.extend({
        ...
        schema: {
            ...
            splitRatioPercentage: { type: 'Hidden'},
            subscriptionCurrencyCode: { type: 'Hidden'},
            licensorAgreementId: { type: 'Hidden' }
        },
        ...
        parse: function (resp) {
            ...
            resp['displayFeeValue'] = resp['feeValue'] + " " + resp['subscriptionCurrencyCode'];
            return resp;
        }
