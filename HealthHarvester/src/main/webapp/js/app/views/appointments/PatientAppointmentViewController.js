define([
    ...
    var MainView = require('mainView'),
        ...
        PatientAppointmentTableView = require('patientAppointmentTableView'),
        PatientAppointmentModel = require('patientAppointmentModel'),
        AppDetailView = require('appDetailView'),
        AddAppointmentView = require('addAppointmentView');
    var that = this;
    ...
    return MainView.extend({
        ...
        onShow: function () {
            ...
            this.cancelAppButton = $('#cancelAppButton');
        ...
        showAppointments :function(){
            ...
            NR.licensorsLayout.licensorsPanel.show(new PatientAppointmentTableView({event: this.licEvt}));
            this.addButton.text("Add appointment for patient");
            this.addDiv.show();
        ...
        appSelectedHandler: function(app){
            ...
            this.currentModel = new PatientAppointmentModel(app);
            this.detailTab.show();
            this.addDiv.show();
            this.cancelAppButton.show();
...
//            this.detailElement();
        ...
        addElement: function () {
            ...
            NR.licensorsLayout.agreementDetail.show(new AddAppointmentView({licEvt: this.licEvt}));
        ...
        getProperAddView: function () {
            ...
            currentView = new AddAppointmentView({model: new PatientAppointmentModel(), licEvt: this.licEvt});
            this.licensorDetailTitle.text('Appointment');
