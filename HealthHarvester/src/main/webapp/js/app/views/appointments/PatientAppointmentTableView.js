define([
    'text!templates/appointments/patientAppointmentsTableView.html',
    'mainView',
    'patientAppointments'

], function (template) {
    var LicensorCollection = require('patientAppointments'),
        ...
        onShow: function () {
            ...
            this.licensorTable.dataTable({
                ...
                aoColumns: [
                    ...
                    { mDataProp: 'doctor', name: 'name', bSearchable: true },
